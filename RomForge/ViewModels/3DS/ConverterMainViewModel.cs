...
public class ConverterMainViewModel : ToolTabViewModel
{
    ...
    private static async Task<FileItemViewModel> ParseFile(string path)
    {
        ...
        FileItemViewModel result = new(path)
        {
    ...
    private async Task RunAsync()
    {
        ...
        using (BeginWork())
        {
            try
            {
                ...
                AppendLog($"총 {totalCount}개의 3DS 변환 작업을 시작합니다.", LogLevel.Info);
